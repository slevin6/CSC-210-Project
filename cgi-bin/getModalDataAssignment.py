...
def print_assignment(x):
	print'''
	<div class="dataInner" style="font-size: medium;">
		Name of Assignment<br><input type="text" name="name" style="margin-left: 11%" value=''' + str(x[1]) + ''' readonly></input><br><br>
		Class<select name="className" id="getClassDropdown" style="margin: 0 0 3% 1%" value=''' + str(x[5]) + '''></select><br>
